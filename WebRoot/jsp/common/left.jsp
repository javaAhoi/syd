		...
		<div class="zx_left_nav left_nav_bg">
			...
			<div class="zx_left_nav_box_list">
				<ul> 
					...
					<li class="<c:if test="${fn:contains(request_action_key, '/movieLan/')}">active</c:if>">
						<a href="${ctx}/movieLan/list">语种配置</a>
					</li>

					<li class="<c:if test="${fn:contains(request_action_key, '/movieYear/')}">active</c:if>">
						<a href="${ctx}/movieYear/list">年代配置</a>
					</li>
