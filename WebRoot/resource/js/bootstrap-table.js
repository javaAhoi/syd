...
! function($) {
	...
	BootstrapTable.prototype.initPagination = function() {
		...
		html.push(
			...
			this.options.formatShowingRows("<span style='color:#399EE5'>"+this.pageFrom+"</span>", "<span style='color:#399EE5'>"+this.pageTo+"</span>", "<span style='color:#399EE5'>"+this.options.totalRows+"</span>"),
			'</span>');
		...
		var pageNumber = [
				sprintf('<span class="btn-group %s">', this.options.paginationVAlign === 'top' || this.options.paginationVAlign === 'both' ?
					'dropdown' : 'dropup'),
				'<button style="padding:4px 12px" type="button" class="btn btn-default ' + (this.options.iconSize === undefined ? '' : ' btn-' + this.options.iconSize) + ' dropdown-toggle" data-toggle="dropdown">',
				'<span style="margin-right:10px" class="page-size">',
	...
	BootstrapTable.prototype.resetView = function(params) {
		...
		if (this.options.height) {
			...
			//设置表格的高度
			this.$tableBody.css('height', height + 'px');
			//美化滚动条 
			//TODO
			this.$tableBody.niceScroll({
