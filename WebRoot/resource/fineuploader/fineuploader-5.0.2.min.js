...
var qq = function(a) {
    ...
    return {
        ...
        getByClass: function(b) {
            var c, d = [];
            return a.querySelectorAll ? a.querySelectorAll("." + b) : (c = a.getElementsByTagName("*"), qq.each(c,
            function(a, c) {
                qq(c).hasClass(b) && d.push(c)
            }), d)
        },
        children: function() {
            for (var b = [], c = a.firstChild; c;) 1 === c.nodeType && b.push(c),
            c = c.nextSibling;
            return b
        },
        setText: function(b) {
...
function() {
    ...
    qq.obj2url = function(a, b, c) {
        ...
        return ! c && b ? (e = /\?/.test(b) ? /\?$/.test(b) ? "": "&": "?", d.push(b), d.push(qq.obj2url(a))) : "[object Array]" === Object.prototype.toString.call(a) && "undefined" != typeof a ? qq.each(a,
        function(a, b) {
            f(b, a)
        }) : "undefined" != typeof a && null !== a && "object" == typeof a ? qq.each(a,
        function(a, b) {
            f(b, a)
...
qq.supportedFeatures = function() {
    ...
    return h = a(),
    j = h && qq.isXhrUploadSupported(),
    i = j && !qq.androidStock(),
    k = j && b(),
    l = j && qq.isFileChunkingSupported(),
    m = j && l && !!window.localStorage,
    n = j && c(),
    o = h && (void 0 !== window.postMessage || j),
    q = d(),
    p = e(),
    r = f(),
    s = g(),
    t = j && void 0 !== window.FileReader,
    u = function() {
...
function() {
    ...
    qq.basePublicApi = {
        ...
        drawThumbnail: function(a, b, c, d) {
            ...
            if (this._imageGenerator) {
                ...
                g = {
                    scale: c > 0,
                    maxSize: c > 0 ? c: null
                }; ! d && qq.supportedFeatures.imagePreviews && (f = this.getFile(a)),
                null == f ? e.failure({
                    container: b,
                    error: "未找到文件或URL."
        ...
        log: function(a, b) { ! this._options.debug || b && "info" !== b ? b && "info" !== b && qq.log("[Fine Uploader " + qq.version + "] " + a, b) : qq.log("[Fine Uploader " + qq.version + "] " + a)
        },
        ...
        uploadStoredFiles: function() {
            ...
            else for (; this._storedIds.length;) a = this._storedIds.shift(),
            this._uploadFile(a)
        }
    },
    qq.basePrivateApi = {
        ...
        _createStore: function(a, b) {
            ...
            e = {},
            f = function(a) {
                return qq.isObject(a) ? qq.extend({},
                a) : a
            },
            g = function() {
        ...
        _createUploadHandler: function(a, b) {
            ...
            e = {
                ...
                onProgress: function(a, b, e, f) {
                    d[a] ? (d[a].loaded !== e || d[a].total !== f) && (c._onProgress(a, b, e, f), c._options.callbacks.onProgress(a, b, e, f)) : (c._onProgress(a, b, e, f), c._options.callbacks.onProgress(a, b, e, f)),
                    d[a] = {
                        loaded: e,
                        total: f
                    }
        ...
        _getButtonId: function(a) {
            ...
            if (d instanceof qq.BlobProxy && (d = d.referenceBlob), d && !qq.isBlob(d)) {
                ...
                if (b = d.getElementsByTagName("input"), qq.each(b,
                function(a, b) {
        ...
        _handleNewFile: function(a, b, c) {
            ...
            g = qq.getFilename(a),
            h = a.blob || a,
            i = this._customNewFileHandler ? this._customNewFileHandler: qq.bind(d._handleNewFileGeneric, d); ! qq.isInput(h) && h.size >= 0 && (f = h.size),
        ...
        _isAllowedExtension: function(a, b) {
            var c = !1;
            return a.length ? (qq.each(a,
            function(a, d) {
                if (qq.isString(d)) {
                    var e = new RegExp("\\." + d + "$", "i");
                    if (null != b.match(e)) return c = !0,
                    !1
                }
            }), c) : !0
        },
        ...
        _onCancel: function(a) {
            ...
            var b = qq.indexOf(this._storedIds, a); ! this._options.autoUpload && b >= 0 && this._storedIds.splice(b, 1),
        ...
        _prepareItemsForUpload: function(a, b, c) {
            if (0 === a.length) return this._itemError("noFilesError"),
            void 0;
...
qq.AjaxRequester = function(a) {
    ...
    function p(a) {
        ...
        i = w.method,
        j = {};
        d(e) || (w.acceptHeader && e.setRequestHeader("Accept", w.acceptHeader), w.allowXRequestedWithAndCacheControl && (w.cors.expected && b() && !c(g) || (e.setRequestHeader("X-Requested-With", "XMLHttpRequest"), e.setRequestHeader("Cache-Control", "no-cache"))), !w.contentType || "POST" !== i && "PUT" !== i || e.setRequestHeader("Content-Type", w.contentType), qq.extend(j, qq.isFunction(g) ? g(a) : g), qq.extend(j, h), qq.each(j,
        function(a, b) {
...
qq.UploadHandlerController = function(a, b) {
    ...
    j = {
        ...
        sendNext: function(a) {
            ...
            function(b, g) {
                ...
                e._getFileState(a).temp.ignoreFailure || (h && (e._getFileState(a).temp.ignoreFailure = !0, qq.each(e._getXhrs(a),
                function(a, b) {
                    b.abort()
    ...
    k = {
        ...
        getWaitingOrConnected: function() {
            var a = [];
            return qq.each(a, k._open),
            qq.each(a, k._waiting)
        },
        ...
        open: function(a, b) {
            ...
            k.available() ? (null == b ? (k._waiting.pop(), k._open.push(a)) : !
            function() {
    ...
    m = {
        ...
        maybeSendDeferredFiles: function(a) {
            ...
            c = !1;
            return b && b.length ? (d("Maybe ready to upload proxy group file " + a), qq.each(b,
            function(b, d) {
                if (m.isDeferredEligibleForUpload(d) && e.getFile(d)) c = d === a,
                m.now(d);
        ...
        normalizeResponse: function(a, b) {
            var c = a;
            return qq.isObject(a) || (c = {},
            qq.isString(a) && !b && (c.error = a)),
            c.success = b,
            c
        },
        now: function(a) {
...
qq.FormUploadHandler = function(a) {
    ...
    qq.extend(this, {
        _attachLoadEvent: function(a, b) {
            var c;
            m ? e(a, b) : k[a.id] = qq(a).attach("load",
            function() {
...
qq.XhrUploadHandler = function(a) {
    ...
    qq.extend(this, {
        ...
        finalizeChunks: function(a, b) {
            ...
            e = c._getXhr(a, d);
            return b ? (new qq.Promise).success(b(e), e) : (new qq.Promise).success({},
            e)
        },
        getFile: function(a) {
        ...
        reevaluateChunking: function(a) {
            if (f && c.isValid(a)) {
                ...
                if (delete d.chunking, d.chunking = {},
                b = c._getTotalChunks(a), b > 1) {
                    d.chunking.enabled = !0,
                    d.chunking.parts = b,
                    d.chunking.remaining = [];
        ...
        _registerProgressHandler: function(a, b, d) {
            ...
            f = {
                ...
                chunked: function(e, f) {
                    var g = c._getFileState(a).temp.chunkProgress,
                    h = c._getFileState(a).loaded,
                    i = e,
                    j = f,
                    l = k(a),
                    m = i - (j - d),
...
qq.Templating = function(a) {
    ...
    function u() {
        ...
        function() {
            S.failure(),
            A("Problem loading 'not available' placeholder image at " + a, "error")
        }) : S.failure(), b ? P.imageGenerator.generate(b, new Image, c).then(function(a) {
            T.success(a)
        },
        function() {
            T.failure(),
            A("Problem loading 'waiting for thumbnail' placeholder image at " + b, "error")
        }) : T.failure())
    }
    function v(a) {
    ...
    function y(a, b) {
        ...
        R[b].then(function() {
            R[a].success(),
            A(qq.format("Now using previously generated thumbnail created for ID {} on ID {}.", b, a)),
            c.src = d.src,
            s(c)
        },
        function() {
            R[a].failure(),
            P.placeholders.waitUntilUpdate || w(a, c)
        })
    }
    function z(a, b, c) {
        var d = q(a);
        return A("Generating new thumbnail for " + a),
        b.qqThumbnailId = a,
        P.imageGenerator.generate(b, d, c).then(function() {
            s(d),
            R[a].success()
        },
        function() {
            R[a].failure(),
            P.placeholders.waitUntilUpdate || w(a, d)
        })
    }
    ...
    A = P.log,
    E = P.containerEl,
    G = void 0 !== P.imageGenerator,
    D = b(),
    u(),
    qq.extend(this, {
        render: function() {
            A("Rendering template in DOM."),
            E.innerHTML = D.template,
            r(p()),
            this.hideTotalProgress(),
            F = P.fileContainerEl || d(E, Q.list),
            A("Template rendering complete")
        },
        ...
        uploadPaused: function(a) {
            this.setStatusText(a, P.text.paused),
        ...
        updateThumbnail: function(a, b, c) {
            ...
            if (d) {
                if (b) return c && v(d),
                P.imageGenerator.generate(b, d, e).then(function() {
                    s(d)
                },
                function() {
                    w(a, d)
...
qq.traditional.FormUploadHandler = function(a, b) {
    "use strict";
    function c(a) {
        var b = {};
        try {
    ...
    function d(a, b) {
        ...
        try {
            ...
            f = e.body.innerHTML;
            i("converting iframe's innerHTML to JSON"),
            i("innerHTML = " + f),
            f && f.match(/^<pre/i) && (f = e.body.firstChild.firstChild.nodeValue),
            d = c(f)
        } catch(g) {
    ...
    function e(b, c) {
        ...
        j = g(b);
        return d[a.uuidName] = h(b),
        d[a.filenameParam] = j,
        f._initFormForUpload({
            method: e,
            endpoint: i,
            params: d,
    ...
    this.uploadFile = function(b) {
        var c, g = f.getInput(b),
        h = f._createIframe(b),
        j = new qq.Promise;
        return c = e(b, h),
        c.appendChild(g),
        f._attachLoadEvent(h,
        function(c) {
            i("iframe loaded");
            var e = c ? c: d(b, h);
            f._detachLoadEvent(b),
            a.cors.expected || qq(h).remove(),
            e.success ? j.success(e) : j.failure(e)
        }),
        i("Sending upload request for " + b),
        c.submit(),
        qq(c).remove(),
        j
    },
...
qq.traditional = qq.traditional || {},
qq.traditional.XhrUploadHandler = function(a, b) {
    "use strict";
    var c = this,
    d = b.getName,
    e = b.getSize,
...
qq.PasteSupport = function(a) {
    ...
    function c() {
        qq(e.targetElement).attach("paste",
        function(a) {
...
qq.DragAndDrop = function(a) {
    ...
    function e(a, b) {
        ...
        b.dropDisabled(!0),
        a.files.length > 1 && !j.allowMultipleItems ? (j.callbacks.processingDroppedFilesComplete([]), j.callbacks.dropError("tooManyFilesError", ""), b.dropDisabled(!1), e.failure()) : (n = [], qq.isFolderDropSupported(a) ? qq.each(a.items,
        function(a, b) {
    ...
    function g(a) {
        var b;
        return qq.each(a.dataTransfer.types,
        function(a, c) {
    ...
    function i() {
        ...
        qq.each(a,
        function(b, c) {
            var d = f(c); ! a.length || qq.ie() && !qq.ie10() || o.attach(document, "dragenter",
            function(b) { ! d.dropDisabled() && g(b) && qq.each(a,
                function(a, b) {
        ...
        o.attach(document, "dragleave",
        function(a) {
            h(a) && b()
        }),
        o.attach(qq(document).children()[0], "mouseenter",
        function() {
            b()
        }),
        o.attach(document, "drop",
        function(a) {
            a.preventDefault(),
            b()
        }),
...
qq.UploadDropZone = function(a) {
    ...
    function c() {
        k || (b ? l.attach(document, "dragover",
        function(a) {
            a.preventDefault()
        }) : l.attach(document, "dragover",
        function(a) {
...
function() {
    ...
    function e(c, e, g, h) {
        ...
        if (f(e, k, l, g.orientation), qq.ios()) {
            ...
            for (var r = q.getContext("2d"), s = h ? b(c, i, j) : 1, t = Math.ceil(p * k / i), u = Math.ceil(p * l / j / s), v = 0, w = 0; j > v;) {
                for (var x = 0,
                y = 0; i > x;) r.clearRect(0, 0, p, p),
                r.drawImage(c, -x, -v),
                m.drawImage(q, 0, 0, p, p, y, w, t, u),
                x += p,
                y += t;
                v += p,
                w += u
    ...
    g.prototype.render = function(a, b) {
        ...
        h && !i ? i = g * h / f << 0 : i && !h ? h = f * i / g << 0 : (h = f, i = g),
        j && h > j && (h = j, i = g * h / f << 0),
        k && i > k && (i = k, h = f * i / g << 0);
        var m = {
            width: h,
...
qq.Exif = function(a, b) {
    ...
    function c(a) {
        for (var b = 0,
        c = 0; a.length > 0;) b += parseInt(a.substring(0, 2), 16) * Math.pow(2, c),
    ...
    function i(a) {
        for (var b = [], c = 0; c + 24 <= a.length;) b.push(a.slice(c, c + 24)),
        c += 24;
        return b
    }
    function j(a, b) {
    ...
    qq.extend(this, {
        isPreviewable: function() {
            ...
            this.isPreviewableSync() ? (b("Second pass: check for magic bytes in file header."), qq.readBlobToHex(a, 0, 4).then(function(a) {
                qq.each(d.PREVIEWABLE_MIME_TYPES,
                function(b, d) {
            ...
            function() {
                b("Error reading file w/ name '" + a.name + "'.  Not able to be rendered in this browser."),
                e.failure()
            })) : e.failure(),
            e
        },
        isPreviewableSync: function() {
            ...
            !e && b(a.name + " is not previewable in this browser per the blob's type attr"),
            e
        }
    })
},
...
qq.Scaler = function(a, b) {
    ...
    qq.extend(this, {
        ...
        getFileRecords: function(a, j, k) {
            ...
            return o.isPreviewableSync() && qq.each(i,
            function(a, c) {
        ...
        handleNewFile: function(a, b, c, d, e, f, g, h) {
            ...
            n = h.paramsStore,
            o = qq.getUniqueId();
            qq.each(i.getFileRecords(c, b, a),
            function(b, c) {
                var f, h = a,
                i = d;
                ...
                c.blob instanceof qq.BlobProxy ? j.push(f) : k = f,
                l(f, h),
                e.push({
                    id: f,
                    file: h
...
qq.extend(qq.Scaler.prototype, {
    scaleImage: function(a, b, c) {
        ...
        return qq.Scaler && qq.supportedFeatures.imagePreviews && f ? qq.bind(function() {
            var b;
            b = k.getFileRecords(i, h, f)[0],
            b ? b.blob.create().then(d.success, d.failure) : (e(a + " is not a scalable image!", "error"), d.failure())
        },
    ...
    _getName: function(a, b) {
        ...
        g = "",
        h = qq.getExtension(a);
        return c >= 0 ? (g = a.substr(0, c), f !== e && (h = e.split("/")[1]), g += d + "." + h) : g = a + d,
        g
    },
...
var ExifRestorer = function() {
    ...
    a.decode64 = function(a) {
        ...
        do d = this.KEY_STR.indexOf(a.charAt(i++)),
...
qq.TotalProgress = function(a, b) {
    ...
    k = function(a, b, c) { (0 === b.length || i(b, c)) && (h(e, e), this.reset())
    },
    l = function(a) {
        var d = b(a);
        d > 0 && (m(a, 0, d), c[a] = {
    ...
    m = function(a, b, f) {
        ...
        i = c[a] ? c[a].total: 0; - 1 === b && -1 === f ? (d -= g, e -= i) : (b && (d += b - g), f && (e += f - i)),
        h(d, e)
    };
    qq.extend(this, {
        onAllComplete: k,
...
qq.FilenameEditHandler = function(a, b) {
    ...
    function f(a, c) {
        b.getDisposeSupport().attach(a, "blur",
        function() {
            e(a, c)
        })
    }
    function g(a, c) {
        b.getDisposeSupport().attach(a, "keyup",
        function(b) {
...
function(a) {
    ...
    function h(b, c) {
        ...
        function(b, c) {
            ...
            h(c, d[b])) : a.isArray(c) ? (e = [], a.each(c,
            function(b, c) {
                var d = {};
...
function(a) {
    ...
    function e(b) {
        var c = b.callbacks = {};
        a.each(new qq.DragAndDrop.callbacks,
        function(a) {
            var b, d = a;
            b = i,
            c[a] = function() {
    ...
    function f(b, c) {
        ...
        function(b, c) {
            ...
            f(c, d[b])) : a.isArray(c) ? (e = [], a.each(c,
            function(b, c) {
...
function() {
    ...
    return {
        ...
        enforceSizeLimits: function(a, b, c) {
            var d = 0 > b ? 0 : b,
            e = 0 >= c ? 9007199254740992 : c; (b > 0 || c > 0) && a.conditions.push(["content-length-range", d.toString(), e.toString()])
        },
    ...
    qq.nonTraditionalBasePrivateApi = {
        _onComplete: function(a, b, c, d) {
            ...
            p = function(f) {
                ...
                h._onAutoRetry(a, b, c, d, g) || (qq.FineUploaderBasic.prototype._onComplete.apply(h, i), m.failure(f))
            };
    ...
    qq.extend(qq.s3.FineUploaderBasic.prototype, {
        ...
        setCredentials: function(a, b) {
            if (a && a.secretKey) {
                ...
                return this._currentCredentials = qq.extend({},
                a),
        ...
        _createUploadHandler: function() {
            ...
            return qq.override(this._endpointStore,
            function(a) {
                return {
                    get: function(b) {
                        var c = a.get(b);
...
qq.s3.CompleteMultipartAjaxRequester = function(a) {
    ...
    function c(a, b, c) {
        ...
        c ? d.failure("Problem asking Amazon to combine the parts!", b) : d.success({},
        b)
    }
    function d(a) {
...
qq.s3.XhrUploadHandler = function(a, b) {
    ...
    q = {
        combine: function(a) {
            ...
            d = new qq.Promise;
            return r.completeMultipart.send(a, b, c).then(d.success,
            function(b, c) {
        ...
        initHeaders: function(b, c) {
            ...
            return r.restSignature.getSignature(b + "." + c, {
                ...
                d = i.getHeaders(),
                d.Authorization = "AWS " + p.get().accessKey + ":" + a.signature,
                h.success(d, i.getEndOfUrl())
            },
            h.failure),
            h
        },
        put: function(b, c) {
            ...
            return q.initHeaders(b, c).then(function(a, h) {
                var i = f + "/" + h;
                o._registerProgressHandler(b, c, e.size),
                t.track(b, d, c).then(g.success, g.failure),
                d.open("PUT", i, !0),
                qq.each(a,
                function(a, b) {
                    d.setRequestHeader(a, b)
        ...
        setup: function(a) {
            ...
            return c ? c instanceof qq.Promise ? c.then(function(a) {
                ...
                o._getPersistableData(a).uploadId = c,
                d.success(c),
                b.success(c)
            },
            function(c) {
                o._getPersistableData(a).uploadId = null,
                b.failure(c),
                d.failure(c)
            })),
            b
    ...
    s = {
        ...
        send: function(a) {
            ...
            c = o._createXhr(a),
            e = o.getFile(a);
            return o._registerProgressHandler(a),
            t.track(a, c).then(b.success, b.failure),
            s.setup(a, c, e).then(function(b) {
        ...
        key: {
            promise: function(a) {
                ...
                return null == d ? (d = new qq.Promise, o._setThirdPartyFileId(a, d), f(a, c(a)).then(function(c) {
                    o._setThirdPartyFileId(a, c),
                    b.success(c)
                },
                function(c) {
                    o._setThirdPartyFileId(a, null),
                    b.failure(c)
                })) : qq.isGenericPromise(d) ? b.then(d.success, d.failure) : b.success(d),
                b
            },
            urlSafe: function(a) {
        ...
        response: {
            parse: function(a, b) {
                ...
                try {
                    ...
                    b.status === e ? f.success = !0 : (c = t.response.parseError(b.responseText), c && (f.error = c.message, f.code = c.code))
                } catch(g) {
    ...
    function(a) {
        return {
            expunge: function(b) {
                ...
                void 0 !== c && d && r.abortMultipart.send(b, c),
                a.expunge(b)
            },
...
qq.s3.FormUploadHandler = function(a, b) {
    ...
    function f(a) {
        ...
        return e(a, b).then(function(e) {
            e.appendChild(d),
            h._attachLoadEvent(b,
            function(d) {
                l("iframe loaded"),
                d ? d.success === !1 && (l("Amazon likely rejected the upload request", "error"), f.failure(d)) : (d = {},
                d.success = c(a, b), d.success === !1 ? (l("A success response was received by Amazon, but it was invalid in some way.", "error"), f.failure(d)) : (qq.extend(d, qq.s3.util.parseIframeResponse(b)), f.success(d))),
                g(a, b)
            }),
...
function() {
    ...
    f.HMAC = c.extend({
        init: function(a, b) {
            ...
            b.clamp();
            for (var f = this._oKey = b.clone(), g = this._iKey = b.clone(), h = f.words, i = g.words, j = 0; c > j; j++) h[j] ^= 1549556828,
            i[j] ^= 909522486;
...
function() {
    ...
    g = e.SHA1 = d.extend({
        ...
        _doProcessBlock: function(a, b) {
            ...
            d = c[0], e = c[1], g = c[2], h = c[3], i = c[4], j = 0; 80 > j; j++) {
                if (16 > j) f[j] = 0 | a[b + j];
                else {
